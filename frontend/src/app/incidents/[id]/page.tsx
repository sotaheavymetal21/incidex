...
export default function IncidentDetailPage() {
  ...
  const handleAddComment = async (e: React.FormEvent) => {
    ...
    try {
      await activityApi.addComment(token!, parseInt(id), {
        comment: newComment,
      });
      setNewComment("");
              ...
              <div className="flex flex-wrap gap-2">
                <span
                  ...
                  style={{
                    ...
                    borderColor: getSeverityStyle(incident.severity)
                      .borderColor,
          ...
          <div className="animate-fadeIn">
            ...
            >
              ...
              >
                ...
                >
                  対応ファイル: 画像 (jpg, png, gif), PDF, テキスト, アーカイブ
                  (zip, tar, gz) - 最大 50MB
                </p>
              </div>
                ...
                >
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      value={entryType}
                      onChange={(e) =>
                        setEntryType(e.target.value as "comment" | "event")
                      }
                    ...
                    <>
                      <div className="mb-4">
                        ...
                        >
                          ...
                          <option value="root_cause_identified">
                            原因特定
                          </option>
                  ...
                  <div className="flex justify-end">
                    ...
                    >
                      {submittingTimelineEvent || submittingComment
                        ? "送信中..."
                        : entryType === "comment"
                          ? "コメントを投稿"
                          : "イベントを登録"}
